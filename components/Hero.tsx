    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative w-full" style={{ minHeight: "clamp(400px, 70vh, 800px)" }}>
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="w-full max-w-7xl mx-auto px-6 md:px-10 pb-12 md:pb-18 lg:pb-22">
            {/* Headline */}
            <h1
            ...
            <p className="mt-4 max-w-xl text-cream-200 text-lg md:text-xl leading-relaxed font-sans">
              A curated antique marketplace with 50+ vendors under one roof in Moore, Oklahoma.
            </p>
