...
export default function Footer() {
  return (
    <footer id="footer" className="bg-stone-950 border-t border-brass/10">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16">
          {/* Contact */}
          <div>
            <h3 className="font-sans font-semibold text-brass text-xs tracking-[0.2em] uppercase mb-5">
              Contact
            </h3>
            <address className="not-italic font-sans text-sm leading-relaxed space-y-3">
              <div>
                <p className="text-cream-200">825 NW 24th Street, Bldg B</p>
                <p className="text-cream-200">Moore, OK 73160</p>
              </div>
              <p>
                <a
                  href="tel:+14056238698"
                  className="text-cream-300/80 hover:text-brass transition-colors duration-250"
                >
                  (405) 623-8698
                </a>
              </p>
          ...
          <div>
            ...
            <div className="font-sans text-sm leading-relaxed space-y-2">
              <div className="flex justify-between max-w-xs">
                ...
                <span className="text-cream-200">9 AM &ndash; 5 PM</span>
              </div>
              <div className="flex justify-between max-w-xs">
          ...
          <div>
              ...
              {quickLinks.map((link) =>
                link.external ? (
                  <a
                    ...
                    className="block text-cream-300/80 hover:text-brass transition-colors duration-250"
                  >
                    {link.label}
                  </a>
                ) : (
            ...
            <h3 className="font-sans font-semibold text-brass text-xs tracking-[0.2em] uppercase mb-4">
              Follow Us
            </h3>
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-stone-500 hover:text-brass transition-colors duration-250"
        ...
        {/* Bottom */}
        <div className="mt-6 pt-6 border-t border-stone-700 space-y-2">
          <p className="text-center text-stone-600 font-sans text-xs tracking-wide">
            &copy; 2026 Antiques in Moore &middot; Moore, Oklahoma
          </p>
